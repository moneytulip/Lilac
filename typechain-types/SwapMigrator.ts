...
export interface SwapMigratorInterface extends utils.Interface {
  contractName: "SwapMigrator";
  functions: {
...
export interface SwapMigrator extends BaseContract {
  contractName: "SwapMigrator";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapMigratorInterface;
