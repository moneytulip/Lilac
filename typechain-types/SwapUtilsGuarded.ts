...
export interface SwapUtilsGuardedInterface extends utils.Interface {
  contractName: "SwapUtilsGuarded";
  functions: {
...
export interface SwapUtilsGuarded extends BaseContract {
  contractName: "SwapUtilsGuarded";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapUtilsGuardedInterface;
