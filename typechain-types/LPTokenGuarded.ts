...
export interface LPTokenGuardedInterface extends utils.Interface {
  contractName: "LPTokenGuarded";
  functions: {
...
export interface LPTokenGuarded extends BaseContract {
  contractName: "LPTokenGuarded";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LPTokenGuardedInterface;
