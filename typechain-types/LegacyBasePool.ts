...
export interface LegacyBasePoolInterface extends utils.Interface {
  contractName: "LegacyBasePool";
  functions: {
...
export interface LegacyBasePool extends BaseContract {
  contractName: "LegacyBasePool";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyBasePoolInterface;
